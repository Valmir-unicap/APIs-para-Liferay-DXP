...
public class webContentRestServiceApplication extends Application {
    ...
    @POST
    @Path("/filtar-nome")
    public Response filterWebContentFolderName(String payload) throws JSONException {
        ...
        try {
            ...
            String nomeArquivo = pontJornalArticle.getFolder().getName();

            arquivo = String.valueOf(object.put("arquivo",nomeArquivo));
