...
@Component(immediate = true, property = {
        ...
        JaxrsWhiteboardConstants.JAX_RS_NAME + "=Email.Rest",
        "auth.verifier.guest.allowed=true",
        "liferay.access.control.disable=true"
},
        service = Application.class)
public class CredenciadoRestServiceApplication extends Application {
    ...
    public Response gravarNomeListaDinamica(String payload) throws JSONException {
        ...
        try {
            ...
            if (recordSet == null) {
                _log.error(object);
                return Response.status(Response.Status.BAD_REQUEST)
                        .entity("{\"error\":\"Bad Request: Nome da lista não foi encontrado.\"}").build();
            }
    ...
    public Response testEndpoint() {
        return Response.ok("{\"message\":\"Teste de conexão bem-sucedido\"}", MediaType.APPLICATION_JSON).build();
    }
    ...
    private final Log _log = LogFactoryUtil.getLog(CredenciadoRestServiceApplication.class);
}
